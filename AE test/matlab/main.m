...
figure;
subplot(1, 2, 1);
plot(price_data.Var1, price_data.Var2);
title('T1');
subplot(1, 2, 2)
plot(price_data.Var1, price_data.Var3);
title('T2');


%%percent of missing values
%what is the maximum range of continuous data
%create a histogram of number of missing values

%interpolate missing values based on window size from nan histogram

% https://au.mathworks.com/help/matlab/matlab_prog/clean-timetable-with-missing-duplicate-or-irregular-times.html
